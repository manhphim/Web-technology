    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="">
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control" id="item-name" placeholder="Enter name" name="">
                    </div>
                    <div class="mb-3">
                        <label for="item-detail" class="form-label">Details</label>
                        <input type="text" class="form-control" id="item-detail" placeholder="Enter details" name="">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="datetime-local" id="meeting-time"
                               name="meeting-time" value="{currentTime}"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-warning">Add changes</button>
            </div>
        </div>
    </div>
</div>
